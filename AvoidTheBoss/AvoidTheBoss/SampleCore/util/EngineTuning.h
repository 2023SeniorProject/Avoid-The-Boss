...
public:
    ...
    void SetMaxValue(float value) { m_MaxValue = value; m_MinValue = min(m_MinValue, value); }
    void SetMinValue(float value) { m_MinValue = value; m_MaxValue = max(m_MaxValue, value); }
...
public:
    ...
    void SetMaxValue(int value) { m_MaxValue = value; m_MinValue = min(m_MinValue, value); }
    void SetMinValue(int value) { m_MinValue = value; m_MaxValue = max(m_MaxValue, value); }
