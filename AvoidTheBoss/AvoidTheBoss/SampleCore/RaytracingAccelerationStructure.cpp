    ...
    bool bForceBuild)
{
    ...
    // Build all bottom-level AS.
    {
        ...
        for (auto& bottomLevelASpair : m_vBottomLevelAS)
        {
            ...
            if (bForceBuild || bottomLevelAS.IsDirty())
            {
                ...
                CD3DX12_RESOURCE_BARRIER uav = CD3DX12_RESOURCE_BARRIER::UAV(bottomLevelAS.GetResource());
    ...
    // Build the top-level AS.
    {
        ...
        CD3DX12_RESOURCE_BARRIER uav = CD3DX12_RESOURCE_BARRIER::UAV(m_topLevelAS.GetResource());
        commandList->ResourceBarrier(1, &uav);
    }
}
