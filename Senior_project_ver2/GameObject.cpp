...
void CGameObject::SetObjectInWorld(CGameObject** ppObjects, int i, XMFLOAT3 position, CMesh* pMesh, int nIndex,	D3D12_GPU_DESCRIPTOR_HANDLE d3dCbvGPUDescriptorStartHandle)
{
	SetMesh(nIndex, pMesh);
	SetPosition(position);
	SetCbvGPUDescriptorHandlePtr(d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * i));
	ppObjects[i] = this;
}
